# Common Design Tools, Not started
...
When it comes to designing new features or applications, a good first step would be to create a design brief设计概要.
...
The first element is the overview总览 of the project and business. This overview should include the company's details, mission, values, unique selling points, and products or services.
...
Another key element would be the project scope. This should include the deliverables交付成果, timeline, and budget. The deliverables should include a list of all the items that will be produced as part of the project, such as mockups设计原型图, and final designs.
