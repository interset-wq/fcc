# Working with Strings in JavaScript 字符串
...
## What Is Bracket Notation, and How Do You Access Characters from a String? 方括号表示法
...
## How Do You Create a Newline in Strings and Escape Strings? 转义字符
...
## What Are Template Literals, and What Is String Interpolation? 模板字符串
...
## How Can You Find the Position of a Substring in a String? 子字符串或字符在字符串中的索引
...
## What Is the prompt() Method, and How Does It Work? 输入框弹窗
